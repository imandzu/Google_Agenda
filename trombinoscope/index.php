 ...
 <nav class="navbar navbar-inverse">
  <div class="container-fluid">
	...
	<li><a class="navbar-brand" href="../">Home</a></li>
	  ...
	  <li class="active"><a href="">Trombinoscope</a></li>
...
<button type="submit" name="send" id="envoyer" value="send">Envoyé</button>
